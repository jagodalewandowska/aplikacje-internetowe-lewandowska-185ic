...
INSTALLED_APPS = [
    ...
    # dodając go cors headers umożliwia zasobom aby był do nich dostęp
    # na innych domenach
    'corsheaders',
]
...
MIDDLEWARE = [
    # do aplikacji crud
    # musi być umiejscowiony jak najwyżej - zwłaszcza przed common
    # middleware, czyli takimi elementami które generują odpowiedzi
    # chodzi tutaj o CommonMiddleware
