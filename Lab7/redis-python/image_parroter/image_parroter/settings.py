...
INSTALLED_APPS = [
    ...
    # dodanie utworzonego thumbnailera do aplikacji
...
# dodanie media root do thumnailera, skąd będzie podawana zawartość 
# utworzenie lokalizacji miejsc jeśli nie istnieją
