...
# posługiwanie się skrótem sha w celu uruchomienia skryptu w sieci
# jest zapisany komentą script load, gdzie jako argument podajemy
# skrypt a on zwraca skrót. zamienia on eval na evalsha
